...
const AddTheme: React.FC = () => {
  ...
  const handleCheckboxChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFormData((prev) => ({
      ...prev,
      roomMapping: checked
        ? [...prev.roomMapping, value] // Add if checked
        : prev.roomMapping.filter((item) => item !== value), // Remove if unchecked
    }));
  };
  ...
  const handleCancel = () => {
    router.push("/home-catalog/themes"); // Navigate back
  };
                  ...
                  <FormGroup>
                    <FormControlLabel
                      control={
                        <Checkbox
                          value="Kitchen"
                          checked={formData.roomMapping.includes("Kitchen")}
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          value="Living Room"
                          checked={formData.roomMapping.includes("Living Room")}
                          onChange={handleCheckboxChange}
                        />
                      }
                      label="Living Room"
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          checked={formData.roomMapping.includes("Master Bedroom")}
                          onChange={handleCheckboxChange}
                        />
                      }
